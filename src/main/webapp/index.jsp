...
<body>
    ...
    <div class="container-geral">
        ...
        // Recuperar a lista de aulas da sessão
        ...
        <div class="container-aula">
            <div class="container-linha1">
                <div class="info">
                    Data: <span class="texto"><%= a.data %></span>
                </div>
                <div class="info">
                    Hora: <span class="texto"><%= a.horario %></span>
                </div>
                <div class="info">
                    Duração(h): <span class="texto"><%= a.duracao %></span>
                </div>
            </div>
            <div class="container-linha2">
                <div class="info">
                    Disciplina: <span class="texto"><%= a.disciplina %></span>
                </div>
                <div class="info">
                    Assunto: <span class="texto"><%= a.assunto %></span>
                </div>
            </div>
