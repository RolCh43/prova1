	...
	<div class="container-geral">
		...
		<div class="container-aula">
			<div class="container-linha1">
				<div class="info">
					Data: <span class="texto"></span>
				</div>
				<div class="info">
					Hora: <span class="texto"></span>
				</div>
				<div class="info">
					Duração(h): <span class="texto"></span>
				</div>
			</div>
			<div class="container-linha2">
				<div class="info">
					Disciplina: <span class="texto"></span>
				</div>
				<div class="info">
					Assunto: <span class="texto"></span>
				</div>
			</div>
